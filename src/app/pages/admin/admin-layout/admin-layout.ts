...
export class AdminLayoutComponent {
  ...
  navItems: NavItem[] = [
    ...
    { label: 'Delivery Partners', icon: 'pi pi-id-card', route: '/admin/delivery-partners' },
    { label: 'Live Monitor', icon: 'pi pi-map', route: '/admin/delivery-monitor' },
    ...
    { label: 'Customer Reviews', icon: 'pi pi-comments', route: '/admin/reviews' },
    { label: 'Showcase Gallery', icon: 'pi pi-image', route: '/admin/gallery' },
